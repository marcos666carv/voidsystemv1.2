        ...
        <div className="w-full max-w-5xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-3 border border-slate-100 p-2 rounded-3xl bg-slate-50/50">
                        {LOCATIONS.map((loc) => {
                ...
                <div>
                    ...
                    <div className="flex justify-center lg:justify-start">
                        <Calendar
                            ...
                            locale={ptBR}
                            className="rounded-2xl border border-slate-200 bg-white p-3 shadow-sm w-full md:w-auto mx-auto lg:mx-0"
            ...
            {tempDate && tempTime && selectedLocationId && (
                <div className="mt-8 p-4 bg-emerald-50 border border-emerald-100 rounded-xl flex items-center gap-3 text-emerald-800 animate-in fade-in duration-300 w-full">
