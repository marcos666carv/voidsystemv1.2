            ...
            <section className="relative overflow-hidden bg-[#0c1117] h-screen">
                <div className="grid lg:grid-cols-2 h-full">
                    ...
                    <div className="relative hidden lg:block">
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-r from-[#0c1117] via-[#0c1117]/20 to-transparent" />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#0c1117] via-transparent to-transparent" />
                    </div>
